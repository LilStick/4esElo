...
- Web/API : vraies photos Discord partout (classement, profil, home, comparaison, panel admin…) au lieu des initiales — `/me` renvoie l'avatar frais de la session, et le snapshot DB se rafraîchit à chaque connexion au lieu de rester figé depuis l'inscription. (#279)
